...
class CapstoneTestCase(unittest.TestCase):
    ...
    def test_delete_movie(self):
        ...
        res = self.client().delete('https://capstone-project-satas.herokuapp.com/movies/4',
           headers={'Authorization': 'Bearer ' + auth_token}
           )
        data = json.loads(res.data)
    ...
    def test_404_delete_movie(self):
        ...
        res = self.client().delete('https://capstone-project-satas.herokuapp.com/movies/10000',
           headers={'Authorization': 'Bearer ' + auth_token}
           )
        data = json.loads(res.data)
    ...
    def test_delete_actor(self):
        ...
        res = self.client().delete('https://capstone-project-satas.herokuapp.com/actors/10',
           headers={'Authorization': 'Bearer ' + auth_token}
           )
        data = json.loads(res.data)
    ...
    def test_404_delete_actor(self):
        ...
        res = self.client().delete('https://capstone-project-satas.herokuapp.com/actors/10000',
           headers={'Authorization': 'Bearer ' + auth_token}
           )
        data = json.loads(res.data)
    ...
    def test_patch_movie(self):
        ...
        res = self.client().patch('https://capstone-project-satas.herokuapp.com/movies/36',
           headers={'Authorization': 'Bearer ' + auth_token},
           json={
    ...
    def test_404_patch_movie(self):
        ...
        res = self.client().patch('https://capstone-project-satas.herokuapp.com/movies/1000',
           headers={'Authorization': 'Bearer ' + auth_token},
           json={
	           "title": "Unit testing a patch of a movie",
	           "release_date": "22 May, 2020"
    ...
    def test_patch_actor(self):
        ...
        res = self.client().patch('https://capstone-project-satas.herokuapp.com/actors/16',
           headers={'Authorization': 'Bearer ' + auth_token},
           json={
	           "name": "Unit testing an actor post",
	           "age": 67,
    ...
    def test_404_patch_actor(self):
        ...
        res = self.client().patch('https://capstone-project-satas.herokuapp.com/actors/1000',
           headers={'Authorization': 'Bearer ' + auth_token},
           json={
	           "name": "Unit testing an actor post",
	           "age": 67,
